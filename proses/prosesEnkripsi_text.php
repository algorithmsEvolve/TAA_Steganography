...
function error_found(){
  header('Location: ../view/encrypt_v.php?x=2');
  die;
}
set_error_handler('error_found');

/*Menerima input dari user*/
$message_to_hide = $_POST['encrypted_text'];
...
$msg = $message_to_hide."///".$password; //To encrypt
...
$namaET = "encrypted_".$randomDigit.".png";
header('Location: ../view/encrypt_v.php?x=1&y='.$namaET);
die;
